...
bool SimStep(Cloth& cloth, PhysicsCloth& sim_phy, const Tensor& h)
{
	...
	std::cout << "FillMV start time: " << start_time << " ms; ";
	std::cout << "FillMV end time: " << end_time << " ms; " << "cost: " << end_time - start_time << " ms" << std::endl;
	...
	end_time = clock();
	std::cout << "Build tensor start time: " << start_time << " ms; ";
	std::cout << "Build tensor end time: " << end_time << " ms; " << "cost: " << end_time - start_time << " ms" << std::endl;
	...
	end_time = clock();
	std::cout << "apply start time: " << start_time << " ms; ";
	std::cout << "apply end time: " << end_time << " ms; " << "cost: " << end_time - start_time << " ms" << std::endl;
	...
	end_time = clock();
	std::cout << "update start time: " << start_time << " ms; ";
	std::cout << "update end time: " << end_time << " ms; " << "cost: " << end_time - start_time << " ms" << std::endl;

	start_time = clock();
	sim_phy.ResetMV();
	end_time = clock();
	std::cout << "ResetMV start time: " << start_time << " ms; ";
	std::cout << "ResetMV end time: " << end_time << " ms; " << "cost: " << end_time - start_time << " ms" << std::endl;
