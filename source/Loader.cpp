...
std::pair<H5ClothSize, H5Physical> cloth_property_loader(std::string filepath) {
	...
	H5File file(filepath.data(), H5F_ACC_RDONLY);
	...
	hid_t cloth_id = H5Tcreate(H5T_COMPOUND, sizeof(H5ClothSize));
	CompType cloth_size(cloth_id);

	H5Tinsert(cloth_id, "width", HOFFSET(H5ClothSize, width), H5T_NATIVE_INT);
	H5Tinsert(cloth_id, "length", HOFFSET(H5ClothSize, length), H5T_NATIVE_INT);
	...
	*/
	hid_t cloth_physical_id = H5Tcreate(H5T_COMPOUND, sizeof(H5Physical));
	CompType cloth_physical(cloth_physical_id);

	H5Tinsert(cloth_physical_id, "Gravity", HOFFSET(H5Physical, gravity), H5T_NATIVE_DOUBLE);
	H5Tinsert(cloth_physical_id, "rho", HOFFSET(H5Physical, rho), H5T_NATIVE_DOUBLE);
	H5Tinsert(cloth_physical_id, "R", HOFFSET(H5Physical, R), H5T_NATIVE_DOUBLE);
	H5Tinsert(cloth_physical_id, "L", HOFFSET(H5Physical, L), H5T_NATIVE_DOUBLE);
	H5Tinsert(cloth_physical_id, "Y", HOFFSET(H5Physical, Y), H5T_NATIVE_DOUBLE);
	H5Tinsert(cloth_physical_id, "B", HOFFSET(H5Physical, B), H5T_NATIVE_DOUBLE);
	H5Tinsert(cloth_physical_id, "kc", HOFFSET(H5Physical, kc), H5T_NATIVE_DOUBLE);
	H5Tinsert(cloth_physical_id, "kf", HOFFSET(H5Physical, kf), H5T_NATIVE_DOUBLE);
	H5Tinsert(cloth_physical_id, "df", HOFFSET(H5Physical, df), H5T_NATIVE_DOUBLE);
	H5Tinsert(cloth_physical_id, "mu", HOFFSET(H5Physical, mu), H5T_NATIVE_DOUBLE);
	H5Tinsert(cloth_physical_id, "S", HOFFSET(H5Physical, S), H5T_NATIVE_DOUBLE);
	H5Tinsert(cloth_physical_id, "handle_stiff", HOFFSET(H5Physical, handle_stiffness), H5T_NATIVE_DOUBLE);
	H5Tinsert(cloth_physical_id, "wind_velocity_x", HOFFSET(H5Physical, wind_velocity_x), H5T_NATIVE_DOUBLE);
	H5Tinsert(cloth_physical_id, "wind_velocity_y", HOFFSET(H5Physical, wind_velocity_y), H5T_NATIVE_DOUBLE);
	H5Tinsert(cloth_physical_id, "wind_velocity_z", HOFFSET(H5Physical, wind_velocity_z), H5T_NATIVE_DOUBLE);
	H5Tinsert(cloth_physical_id, "wind_density", HOFFSET(H5Physical, wind_density), H5T_NATIVE_DOUBLE);
	H5Tinsert(cloth_physical_id, "wind_drag", HOFFSET(H5Physical, wind_drag), H5T_NATIVE_DOUBLE);
	H5Tinsert(cloth_physical_id, "woven_pattern", HOFFSET(H5Physical, woven_pattern), H5T_NATIVE_INT);
...
std::pair<H5ClothSize, H5PhysicalHeterYarn> cloth_property_loader_heter(std::string filepath) {
	...
	H5File file(filepath.c_str(), H5F_ACC_RDONLY);
	/*
	DataSet dataset_size = file.openDataSet("/Properties/Size");
	...
	*/
	...
	hid_t cloth_physical_id = H5Tcreate(H5T_COMPOUND, sizeof(H5PhysicalHeterYarn));
	CompType cloth_physical(cloth_physical_id);

	H5Tinsert(cloth_physical_id, "Gravity", HOFFSET(H5PhysicalHeterYarn, gravity), H5T_NATIVE_DOUBLE);
	H5Tinsert(cloth_physical_id, "Yarn1_rho", HOFFSET(H5PhysicalHeterYarn, rho1), H5T_NATIVE_DOUBLE);
	H5Tinsert(cloth_physical_id, "Yarn2_rho", HOFFSET(H5PhysicalHeterYarn, rho2), H5T_NATIVE_DOUBLE);
	H5Tinsert(cloth_physical_id, "R", HOFFSET(H5PhysicalHeterYarn, R), H5T_NATIVE_DOUBLE);
	H5Tinsert(cloth_physical_id, "L", HOFFSET(H5PhysicalHeterYarn, L), H5T_NATIVE_DOUBLE);
	H5Tinsert(cloth_physical_id, "Yarn1_Y", HOFFSET(H5PhysicalHeterYarn, Y1), H5T_NATIVE_DOUBLE);
	H5Tinsert(cloth_physical_id, "Yarn2_Y", HOFFSET(H5PhysicalHeterYarn, Y2), H5T_NATIVE_DOUBLE);
	H5Tinsert(cloth_physical_id, "Yarn1_B", HOFFSET(H5PhysicalHeterYarn, B1), H5T_NATIVE_DOUBLE);
	H5Tinsert(cloth_physical_id, "Yarn2_B", HOFFSET(H5PhysicalHeterYarn, B2), H5T_NATIVE_DOUBLE);
	H5Tinsert(cloth_physical_id, "kc", HOFFSET(H5PhysicalHeterYarn, kc), H5T_NATIVE_DOUBLE);
	H5Tinsert(cloth_physical_id, "kf", HOFFSET(H5PhysicalHeterYarn, kf), H5T_NATIVE_DOUBLE);
	H5Tinsert(cloth_physical_id, "df", HOFFSET(H5PhysicalHeterYarn, df), H5T_NATIVE_DOUBLE);
	H5Tinsert(cloth_physical_id, "mu", HOFFSET(H5PhysicalHeterYarn, mu), H5T_NATIVE_DOUBLE);
	H5Tinsert(cloth_physical_id, "S", HOFFSET(H5PhysicalHeterYarn, S), H5T_NATIVE_DOUBLE);
	H5Tinsert(cloth_physical_id, "handle_stiff", HOFFSET(H5PhysicalHeterYarn, handle_stiffness), H5T_NATIVE_DOUBLE);
	H5Tinsert(cloth_physical_id, "wind_velocity_x", HOFFSET(H5PhysicalHeterYarn, wind_velocity_x), H5T_NATIVE_DOUBLE);
	H5Tinsert(cloth_physical_id, "wind_velocity_y", HOFFSET(H5PhysicalHeterYarn, wind_velocity_y), H5T_NATIVE_DOUBLE);
	H5Tinsert(cloth_physical_id, "wind_velocity_z", HOFFSET(H5PhysicalHeterYarn, wind_velocity_z), H5T_NATIVE_DOUBLE);
	H5Tinsert(cloth_physical_id, "wind_density", HOFFSET(H5PhysicalHeterYarn, wind_density), H5T_NATIVE_DOUBLE);
	H5Tinsert(cloth_physical_id, "wind_drag", HOFFSET(H5PhysicalHeterYarn, wind_drag), H5T_NATIVE_DOUBLE);
	H5Tinsert(cloth_physical_id, "woven_pattern", HOFFSET(H5PhysicalHeterYarn, woven_pattern), H5T_NATIVE_INT);
	...
	for (int step = 0; step < steps; ++step)
		for (int v = 0; v < length; ++v)
			for (int u = 0; u < width; ++u) {
				...
				// Read L Pos
				std::unique_ptr<DataSet> dataset = std::make_unique<DataSet>(file.openDataSet(LPosDatasetName.data()));
				...
				dataset = std::make_unique<DataSet>(file.openDataSet(LPosFixDatasetName.data()));
				...
				dataset = std::make_unique<DataSet>(file.openDataSet(LVelDatasetName.data()));
				dataspace = dataset->getSpace();
				...
				dataset = std::make_unique<DataSet>(file.openDataSet(EPosDatasetName.data()));
				dataspace = dataset->getSpace();
				...
				dataset = std::make_unique<DataSet>(file.openDataSet(EVelDatasetName.data()));
				dataspace = dataset->getSpace();
				...
				dataset = std::make_unique<DataSet>(file.openDataSet(EPosBarDatasetName.data()));
				dataspace = dataset->getSpace();
