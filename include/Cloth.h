...
struct Cloth {
	int width, length;
	double hight, L, R;	// L rest length of the yarn segment, R yarn radius 
	Tensor kf, df, mu, S, kc, handle_stiffness;	// the equation of F-Slide in page 4
	...
	// LLD Lagrangian-Lagrangian Dimension; ELD Eulerian-Lagrangian Dimension; Eulerian-Eulerian Dimension
